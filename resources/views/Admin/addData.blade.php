...
<html>
<head>
<title>New Entry | E-Pharma</title>
		...
		<div class="card">
		  <div class="card-body">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="name" placeholder="Enter drug name" required>
			      
			  </div>
			  <div class="form-group">
			    <label for="dosage" class="text-white">Dosage</label>
			    <input type="number" class="form-control" name="dosage" placeholder="Enter drug dosage" required>
			    
			  </div>
			   <div class="form-group">
			     <label for="expiry" class="text-white">Expiry date</label>
			    <input type="date" class="form-control" name="expiry" placeholder="Enter expiry date" required>
			   ...
			   <div class="form-group">
  				...
  				<div class="form-group">
  				  ...
  				  <textarea class="form-control" name="effects" rows="3" required></textarea>
